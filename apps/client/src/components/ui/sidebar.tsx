/** biome-ignore-all lint/suspicious/noDocumentCookie: <Default config shadcn> */
/** biome-ignore-all lint/correctness/useExhaustiveDependencies: <Default config shadcn> */
'use client';
